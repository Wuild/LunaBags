...
addon.configsDefaults = {
    profile = {
        ...
        ui = {
            ...
            itemBorderSize = 1,
            itemTextFont = "expressway",
            itemTextSize = 10,
            itemTextOutline = true,
            itemTextShadow = true,
            stackCountAlign = "right",
            stackCountOffsetX = 3,
            stackCountOffsetY = 3,
            stackCountTextSize = 10,
            cooldownTextSize = 10,
        },
        oneBag = {
            columns = 11,
        ...
        plugins = {
            ...
            equipmentSetCategories = false,
            equipmentSetCategoriesOptions = {
                blizzard = true,
                extraStats = true,
                itemRack = true,
                includeHiddenItemRackSets = false,
            },
            trashIcon = true,
            itemLevelText = true,
            questStartMarker = true,
            pawnUpgrade = true,
            pawnUpgradeOptions = {
                anchor = "top_right",
                offsetX = 2,
...
addon.skinPresets = {
    ...
    Sol = {
        label = "Sol",
        ui = {
            windowColor = { r = 0.90, g = 0.87, b = 0.80 },
            windowOpacity = 0.96,
            headerColor = { r = 0.72, g = 0.66, b = 0.56 },
            headerOpacity = 0.98,
            itemFrameColor = { r = 0.72, g = 0.69, b = 0.63 },
            itemFrameOpacity = 0.90,
            itemBorderSize = 1,
            itemTextFont = "expressway",
            itemTextSize = 10,
            itemTextOutline = true,
    ...
    Eclipse = {
        label = "Eclipse",
        ui = {
            windowColor = { r = 0.04, g = 0.04, b = 0.05 },
            windowOpacity = 1.00,
            headerColor = { r = 0.86, g = 0.70, b = 0.22 },
            headerOpacity = 1.00,
            itemFrameColor = { r = 0.90, g = 0.90, b = 0.93 },
            itemFrameOpacity = 0.96,
            itemBorderSize = 3,
            itemTextFont = "expressway",
            itemTextSize = 10,
            itemTextOutline = true,
